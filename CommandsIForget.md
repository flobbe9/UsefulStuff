...
- enable ssl in docker (https://hackmd.io/@linnil1/H1p25uxFU)
    1. mount certificate and key to container in /etc/ssl/certs/
    2. mount ```default-ssl.conf``` file to /etc/apache2/sites-available/default-ssl.conf and specify:
        <VirtualHost *:443>
            DocumentRoot /var/www/html
            ErrorLog ${APACHE_LOG_DIR}/error.log
            CustomLog ${APACHE_LOG_DIR}/access.log combined
            SSLEngine on
            ServerName [domainName]  # Change this
            SSLCertificateFile  /etc/ssl/certs/[cert.crt]  # change this
            SSLCertificateKeyFile /etc/ssl/certs/[key.key]  # Change this
    ...
    3. mount docker entrypoint to /usr/local/bin/docker-entrypoint.sh and change the last lines:
        a. 
            a2enmod ssl
